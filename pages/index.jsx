    ...
    <>
      ...
      <section className="w-[90%] mx-auto px-2 mt-14  font-primary  lg:mb-36 :py-2"  >
        <div className="w-full flex flex-col  lg:flex-row h-auto lg:justify-between   ">
          <div className="w-full lg:w-[60%] mt-4  ">
            <h1 className="text-3xl mt-4 text-black dark:text-cyan-600  " >
              Olá , eu sou o Lucas &#128075;
            </h1>
            ...
            <div className="flex w-28 mt-8 justify-between h-4  ">
              <a className="lg:hover:-mt-2 transition-[margin] ease-in " target='_blank' href="https://github.com/Ianmello10">  
              <AiFillGithub className="w-10 h-10" />
              </a> 
              <a className="lg:hover:-mt-2 transition-[margin] ease-in " target='_blank' href="https://www.linkedin.com/in/lucas-ian-b62195225/">
      ...
      <section className="w-[90%] mx-auto mt-24 mb-10  ">
        ...
        <div className="w-full flex flex-col justify-between mt-6 lg:flex-row">
          <div className=" w-[90%] md:w-[70%] mx-auto mb-6 lg:w-[23%] border-2
      ...
      <section className="w-[90%] mx-auto py-4 mt-24 ">
        <h2 id="projetos" className="text-3xl pl-1 md:text-center lg:text-left lg:px-0">Projetos Recentes</h2>
